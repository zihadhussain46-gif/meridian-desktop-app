...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Meridian Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hermes backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      restartingMessage: 'Meridian Desktop will reconnect using the saved settings.',
  ...
  updates: {
    ...
    manualPickedUp: 'Meridian will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    ...
    applyingClose: 'Meridian will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Meridian needs a one-time install',
  ...
  onboarding: {
    ...
    preparingInstall: 'Meridian is finishing install. This usually takes under a minute on first run.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Meridian Desktop v${version}`,
      ...
      gatewayTitle: 'Meridian inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Meridian is restarting...',
      askRestart: 'Ask Hermes to restart the server',
      lookingRestart: taskId => `Meridian is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Meridian is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Meridian finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Meridian could not restart the server.',
      stillWorking:
        'Meridian is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Meridian is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Meridian gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: 'Meridian needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Meridian needs a credential to continue.',
